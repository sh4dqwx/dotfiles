...
main() {
	...
	pacman -S base-devel cmatrix fd gcc git go imagemagick less lolcat neovim openssh python ripgrep rustup stow sudo terraform tmux wl-clipboard zsh --noconfirm
